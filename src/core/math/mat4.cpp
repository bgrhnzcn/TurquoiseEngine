...
auto Mat4::getRawData() -> float*
{
	return &(this->col1.x);
}

auto Mat4::getRow(unsigned int index) -> Vec4
{
...
auto Mat4::Scale(const Vec3& values) -> Mat4
{
	Mat4 result;
...
auto Mat4::Translate(const Vec3& values) -> Mat4
{
	Mat4 result;
...
auto Mat4::operator*(const Mat4& other) -> Mat4
{
	Mat4 result;
	...
	result.col1.x = math::dot(row1, other.col1);
	result.col2.x = math::dot(row1, other.col2);
	result.col3.x = math::dot(row1, other.col3);
	result.col4.x = math::dot(row1, other.col4);

	result.col1.y = math::dot(row2, other.col1);
	result.col2.y = math::dot(row2, other.col2);
	result.col3.y = math::dot(row2, other.col3);
	result.col4.y = math::dot(row2, other.col4);

	result.col1.z = math::dot(row3, other.col1);
	result.col2.z = math::dot(row3, other.col2);
	result.col3.z = math::dot(row3, other.col3);
	result.col4.z = math::dot(row3, other.col4);

	result.col1.w = math::dot(row4, other.col1);
	result.col2.w = math::dot(row4, other.col2);
	result.col3.w = math::dot(row4, other.col3);
	result.col4.w = math::dot(row4, other.col4);
